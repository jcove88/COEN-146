/* Jillian Coveney
 * Thursday 5:15 
 * Lab6, step 1: UDP server with packets that have checksum, sequence number, acknowledgement number, and timer
 */
...
int main(int argc, char *argv[]) {
	...
	perror("Failure in binding server address to endpoint socket\n");
	exit(1);
    }
